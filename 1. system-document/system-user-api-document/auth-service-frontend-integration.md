...
说明：当前最近一次 AuthFlowControllerIT 结果为 27 passed / 0 failed；另外 PasswordTransportSecurityServiceTest 为 2 passed / 0 failed，RegisterEmailTemplateRendererTest 为 3 passed / 0 failed，本轮总验证结果为 32 passed / 0 failed。
