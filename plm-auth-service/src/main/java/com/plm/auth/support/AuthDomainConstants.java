...
public final class AuthDomainConstants {
    ...
    public static final String LOGIN_TYPE_PLATFORM_ADMIN = "platform_admin";
    ...
    public static final String ROLE_CODE_PLATFORM_SUPER_ADMIN = "platform_super_admin";
    public static final String ROLE_CODE_PLATFORM_ADMIN = "platform_admin";
    public static final String ROLE_CODE_PLATFORM_OPERATOR = "platform_operator";
    public static final String ROLE_CODE_PLATFORM_AUDITOR = "platform_auditor";
    public static final String PERMISSION_PLATFORM_STORAGE_CLUSTER_MANAGE = "platform.storage.cluster.manage";
    public static final String PERMISSION_PLATFORM_STORAGE_CLUSTER_TEST = "platform.storage.cluster.test";
    ...
    public static final String PERMISSION_STORAGE_OBJECT_DELETE = "storage.object.delete";
    public static final String PERMISSION_STORAGE_OBJECT_MANAGE = "storage.object.manage";
