...
public class MetaCategoryBrowseController {
    ...
    public ResponseEntity<List<MetaCategoryBrowseNodeDto>> families(@PathVariable("segmentCodeKey") String segmentCodeKey) {
    ...
    public ResponseEntity<List<MetaCategoryClassGroupDto>> classesWithCommodities(@PathVariable("familyCodeKey") String familyCodeKey) {
